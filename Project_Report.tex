...
\captionof{figure}{Web Application - Homepage with Educational Content and Algorithm Overview}
\end{center}
...
\subsubsection{Description}
Playfair Cipher, invented by Charles Wheatstone in 1854, was the first practical digraph (letter pair) substitution cipher. It was used by the British forces in World War I. The cipher uses a 5$\times$5 matrix and encrypts pairs of letters instead of single letters.

\subsubsection{Working Principle}
\begin{enumerate}
    \item Create 5$\times$5 matrix using keyword (I and J are merged)
...
\captionof{figure}{Playfair Cipher - Example showing digraph encryption interface}
\end{center}
...
\begin{enumerate}
    ...
    \item \textbf{Matrix Visualization:} Web UI displays the 5$\times$5 grid
...
\subsubsection{Example (3$\times$3 Matrix)}
\begin{tcolorbox}[colback=gray!10,colframe=gray!50]
\textbf{Key Matrix:}
...
\captionof{figure}{Hill Cipher - Matrix operations visualization}
\end{center}
...
\begin{enumerate}
    \item \textbf{Variable Matrix Size:} Support for 2$\times$2, 3$\times$3, or larger matrices
...
\textbf{Complete 3$\times$3 Example:}
\begin{verbatim}
Key Matrix K:
+----------+
| 6  24  1 |
...
\begin{itemize}
    ...
    \item \textbf{Educational Value:} Perfect example of why "obscurity $\neq$ security"
\end{itemize}
...
\captionof{figure}{Homepage - Algorithm Cards with Historical Context and Security Analysis (Expandable)}
\end{center}

\begin{center}
\includegraphics[width=0.9\textwidth]{assets/screenshot-step-by-step-1.png}
\captionof{figure}{Step-by-Step Visualization Component - Character-by-Character Encryption Process}
\end{center}

\begin{center}
\includegraphics[width=0.9\textwidth]{assets/screenshot-hill-cipher.png}
\captionof{figure}{Step-by-Step Visualization Controls - Play/Pause, Speed Adjustment, and Step Navigation}
\end{center}
...
Hill (2$\times$2) & ACT & [6,24,1;13,16,10;20,17,15] & POH \\
...
The homepage provides comprehensive educational material for all 8 algorithms with expandable algorithm cards.
...
\begin{center}
\includegraphics[width=0.9\textwidth]{assets/screenshot-cipher-selection.png}
\captionof{figure}{Cipher Playground - Algorithm Selection and Parameter Configuration Interface}
\end{center}

\begin{center}
\includegraphics[width=0.9\textwidth]{assets/screenshot-caesar-cipher.png}
\captionof{figure}{Caesar Cipher Interface - Real-time Encryption with Shift Parameter Control}
\end{center}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Hill (2$\times$2 and 3$\times$3 matrices)
...
Hill (3$\times$3) & ATTACKATDAWN & 6,24,1;... & \textcolor{green}{Pass} \\
